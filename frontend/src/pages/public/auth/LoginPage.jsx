...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-peach-light text-brown font-sans overflow-hidden">
      <header className="h-16 flex items-center  justify-between px-7 max-[980px]:px-4 py-10">
      ...
      <main className="max-w-[1180px] mx-auto mt-3.5 mb-10 px-6 py-6 bg-brown/10  rounded-[5px]">
        <section className="grid grid-cols-[1.1fr_.9fr] gap-10 items-stretch max-[980px]:grid-cols-1">
          ...
          <div className="flex flex-col gap-5 justify-center py-2.5 h-fit">
            <h1 className="font-display font-instrument-serif text-center text-[54px] leading-[1.05] tracking-[.4px] mb-6 max-[980px]:text-[60px]">
              Log in
            </h1>
            ...
            <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
              <input
                className={`w-full h-12 border border-brown rounded-[5px] px-3.5 bg-peach-light outline-none  placeholder:text-brown/60 focus:border-brown focus:ring-4 focus:ring-brown/30 à`}
                placeholder="E-mail"
                value={email}
                type="email"
